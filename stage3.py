...
def reiniciar_jogo():
    ...
    objeto_bala.rect.x = constantes.LARGURA/2
    som_jogando.play()
...
class Bala(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.rect.x = constantes.LARGURA - randrange(50, 550, 50)
...
while True:
    ...
    if pontos >= 500 and colidiu == False:
    ...
    if pontos >= 800:
        vencedor = exibir('Nivel 01 concluido.', 30, constantes.BRANCO)
